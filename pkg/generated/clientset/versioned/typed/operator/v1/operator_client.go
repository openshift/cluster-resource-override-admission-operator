...
// OperatorV1Client is used to interact with features provided by the operator.autoscaling.openshift.io group.
type OperatorV1Client struct {
	restClient rest.Interface
}

func (c *OperatorV1Client) ClusterResourceOverrides() ClusterResourceOverrideInterface {
